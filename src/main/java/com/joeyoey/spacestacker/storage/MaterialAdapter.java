...
public class MaterialAdapter implements JsonDeserializer<Material>, JsonSerializer<Material> {
    /**
    ...
    public Material deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        try {
            Material entityType = Material.valueOf(jsonObject.get("material").getAsString());
            return entityType;
        } catch (Exception e) {
    ...
    public JsonElement serialize(Material src, Type typeOfSrc, JsonSerializationContext context) {
        ...
        jsonObject.addProperty("material", src.name());
        return jsonObject;
    }
}
